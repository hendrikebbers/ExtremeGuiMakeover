...
public class ViewFactory {
    ...
    public static Parent createMasterDetailView(final Database database) throws IOException {
        ...
        final MasterDetailViewController controller = new MasterDetailViewController(model);
